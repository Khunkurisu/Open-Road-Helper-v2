...
namespace Bot.PF2
{
    public static class Helper
    {
        ...
        public static int[] SimpleDCs = new int[] { 10, 15, 20, 30, 40 };
        public static int[] DCAdjustment = new int[] { -10, -5, -2, 2, 5, 10 };
        public static double[,] IncomeTable = new double[,]
        {
        ...
        public static int[,] PartyTreasure = new int[,]
        {
            { 40, 10 },
            { 70, 18 },
            { 120, 30 },
